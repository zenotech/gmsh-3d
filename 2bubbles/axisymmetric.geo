...
k=10000;
Point(k+1) = {-wallLength/2.0, 
               wallLength/2.0, 
              -wallLength/2.0, 
              wall}; // p1
Point(k+2) = { wallLength/2.0,
               wallLength/2.0,
              -wallLength/2.0,
              wall}; // p2
Point(k+3) = { wallLength/2.0,
              -wallLength/2.0, 
              -wallLength/2.0,
              wall}; // p3
Point(k+4) = {-wallLength/2.0,
              -wallLength/2.0,
              -wallLength/2.0, 
              wall}; // p4
...
Physical Surface('wallInflow2AxiBubbles') = {k+15, k+23};
Physical Surface('wallOutflow') = {k+19, k+28, k+27, k+06};
