...
Periodic Surface 34 {14,15,16,17} = 10 {1,2,3,4};
Periodic Surface 76 {14,15,16,17,40,41,42,43} = 12 {1,2,3,4,5,6,7,8};

// For correct orientation, the normal vectors must be pointed outward.
Physical Surface('wallNoSlip') = {-75, -63, -67, -71, -76, 12, -34, 10};
Physical Surface('bubble1') = {-33, -29, -25, -21};
